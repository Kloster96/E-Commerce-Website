...
└── README.md                 # This file
```
Entiendo perfectamente. El problema es que al anidar bloques de código dentro de otro bloque, el formato se rompe si no se maneja con cuidado.

Aquí tienes el archivo completo, sin fragmentar y con todos los comandos de terminal corregidos para que se vean bien en GitHub. Solo dale al botón de copiar:
